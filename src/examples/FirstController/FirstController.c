 ...
 */
__EXPORT int FirstController_main(int argc, char *argv[]);
...
// --------------------------------------------------------- MAIN ---------------------------------------------------------//
int FirstController_main(int argc, char *argv[]){
  if (argc < 2) {
...
// --------------------------------------------------- basic controller ------------------------------------------------------//
int BasicController(void);

int BasicController(void){
  float yaccel_d= 0.0f;
  
  float yerr= yaccel_d - raw.accelerometer_m_s2[1];
  
  float minOut= -0.65;
  
  actuators.control[0]= (1.0f/9.0f)*yerr + minOut;
  actuators.control[3]= (1.0f/9.0f)*yerr + minOut;

  actuators.control[1]= -(1.0f/9.0f)*yerr + minOut;
  actuators.control[2]= -(1.0f/9.0f)*yerr + minOut;
